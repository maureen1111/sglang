...
class Envs:
    ...
    SGLANG_NVFP4_CKPT_FP8_GEMM_IN_ATTN_O_PROJ = EnvBool(False)
    SGLANG_NVFP4_CKPT_FP8_GEMM_IN_DENSE_MLP = EnvBool(False)
    SGLANG_NVFP4_CKPT_FP8_GEMM_IN_SHARED_EXPERT = EnvBool(False)
